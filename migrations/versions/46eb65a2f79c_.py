...
Revision ID: 46eb65a2f79c
Revises: 
Create Date: 2023-12-21 09:58:43.653957
...
def upgrade():
    ...
    sa.Column('cars', sa.String(length=200), nullable=True),
    sa.Column('fav_language', sa.String(length=200), nullable=True),
    sa.Column('create_date', sa.DateTime(), nullable=True),
    sa.PrimaryKeyConstraint('firstname', name=op.f('pk_form'))
    )
